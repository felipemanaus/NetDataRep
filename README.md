...
* Processamento e latência de processamento incrivelmente eficientes com tempo médio variando de $0.0024~ms/pkt$ (Service) a $ pprox0.0149~ms/pkt$ (Biflow), atendendo aos requisitos estritos de IoT/5G para monitoramento em tempo real em $O(N)$ de complexidade de escalonamento.
